...
public class GetStudentAllClassDetailTest {
    ...
    void testGetTeacherClassDetailsWithValidData() throws Exception {
        Mockito.when(studentService.getAllClassDetail(2L,1L)).thenReturn(new GetStudentClassDetailResponse());

        mockMvc.perform(get(ApiUrls.GET_STUDENT_ALL_CLASS_DETAILS)
