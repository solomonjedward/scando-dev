...
public class GetTeacherAllClassDetailsTest {
    ...
    void testGetTeacherClassDetailsWithValidData() throws Exception {
        Mockito.when(teacherService.getAllClassDetails(2L,0L)).thenReturn(new GetTeacherClassDetailsResponse());

        mockMvc.perform(get(ApiUrls.GET_TEACHER_ALL_CLASS_DETAILS)
